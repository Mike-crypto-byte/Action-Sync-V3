...
const App = () => {
  ...
  if (selectedGame === 'craps') {
    return <CrapsGame onBack={() => isDealerMode ? setSelectedGame(null) : null} isDealerMode={isDealerMode} />;
  }

  if (selectedGame === 'baccarat') {
    return <BaccaratGame onBack={() => isDealerMode ? setSelectedGame(null) : null} isDealerMode={isDealerMode} />;
  }

  if (selectedGame === 'roulette') {
    return <RouletteGame onBack={() => isDealerMode ? setSelectedGame(null) : null} isDealerMode={isDealerMode} />;
  }
