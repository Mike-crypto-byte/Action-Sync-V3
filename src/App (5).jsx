...
const App = () => {
  ...
  const handleDealerLogin = async () => {
    if (dealerPassword === DEALER_PASSWORD) {
      ...
      setDealerPassword('');
      // Register dealer in shared session so they skip per-game login
    ...
    try {
      ...
      if (lbSnap.exists()) {
        ...
        const players = Object.values(lbData)
          .filter(p => !p.isAdmin && p.name !== (dealerName.trim() || 'Dealer'))
          ...
          {showSessionSummary && sessionLeaderboard && sessionLeaderboard.length > 0 ? (
            <>
                ...
                <div style={{
                  ...
                  {sessionLeaderboard.length >= 2 && (
                    <div style={{
                      ...
                      borderRadius: '12px', padding: '20px 15px', width: '140px',
                      textAlign: 'center'
                    }}>
                      ...
                      <div style={{
                        ...
                        color: sessionLeaderboard[1].bankroll >= 1000 ? '#4caf50' : '#f44336'
                      }}>
                        ${Math.round(sessionLeaderboard[1].bankroll).toLocaleString()}
                      </div>
                      <div style={{
                        fontSize: '11px', marginTop: '4px',
                        color: sessionLeaderboard[1].bankroll - 1000 >= 0 ? '#4caf50' : '#f44336'
                      }}>
                        {sessionLeaderboard[1].bankroll - 1000 >= 0 ? '+' : ''}${Math.round(sessionLeaderboard[1].bankroll - 1000).toLocaleString()}
                      </div>
                    </div>
                  )}
                  ...
                  <div style={{
                    ...
                    border: '3px solid #d4af37',
                    borderRadius: '12px', padding: '25px 20px', width: '160px',
                    textAlign: 'center',
                    ...
                    <div style={{
                      ...
                      color: sessionLeaderboard[0].bankroll >= 1000 ? '#4caf50' : '#f44336'
                    }}>
                      ${Math.round(sessionLeaderboard[0].bankroll).toLocaleString()}
                    </div>
                    <div style={{
                      fontSize: '12px', marginTop: '4px',
                      color: sessionLeaderboard[0].bankroll - 1000 >= 0 ? '#4caf50' : '#f44336'
                    }}>
                      {sessionLeaderboard[0].bankroll - 1000 >= 0 ? '+' : ''}${Math.round(sessionLeaderboard[0].bankroll - 1000).toLocaleString()}
                    </div>
                  </div>
                  ...
                  {sessionLeaderboard.length >= 3 && (
                    <div style={{
                      ...
                      borderRadius: '12px', padding: '18px 15px', width: '130px',
                      textAlign: 'center'
                    }}>
                      ...
                      <div style={{
                        ...
                        color: sessionLeaderboard[2].bankroll >= 1000 ? '#4caf50' : '#f44336'
                      }}>
                        ${Math.round(sessionLeaderboard[2].bankroll).toLocaleString()}
                      </div>
                      <div style={{
                        fontSize: '11px', marginTop: '4px',
                        color: sessionLeaderboard[2].bankroll - 1000 >= 0 ? '#4caf50' : '#f44336'
                      }}>
                        {sessionLeaderboard[2].bankroll - 1000 >= 0 ? '+' : ''}${Math.round(sessionLeaderboard[2].bankroll - 1000).toLocaleString()}
                      </div>
                    </div>
                  )}
                </div>
                    ...
                    <div key={idx} style={{
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
                        <span style={{
                          ...
                          color: player.bankroll >= 1000 ? '#4caf50' : '#f44336'
                        }}>
                          ${Math.round(player.bankroll).toLocaleString()}
                        </span>
                        <span style={{
                          fontSize: '11px',
                          color: player.bankroll - 1000 >= 0 ? '#4caf50' : '#f44336'
                        }}>
                          {player.bankroll - 1000 >= 0 ? '+' : ''}${Math.round(player.bankroll - 1000).toLocaleString()}
                        </span>
                      </div>
                    </div>
                  ))}
              ...
              {(() => {
                ...
                const pnl = Math.round(myResult.bankroll - 1000);
                return (
                  <div style={{
    ...
    <div style={{
      ...
      <div style={{ maxWidth: '1200px', width: '100%' }}>
        ...
        <div style={{
          ...
          >
            🛑 Deactivate Game — Send Players to Waiting Screen
          </button>
          <div style={{
            color: '#d4af37',
            fontSize: '13px',
