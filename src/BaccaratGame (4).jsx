...
const BaccaratGame = ({ onBack, isDealerMode = false }) => {
  // User state
  ...
  const confirmBets = async () => {
    ...
    if (totalWagered > 0) {
      ...
      if (netResult > 0) {
        showResultBanner('win', netResult, winnerLabel);
      } else if (netResult === 0) {
        showResultBanner('push', 0, winnerLabel);
      } else {
        showResultBanner('loss', netResult, winnerLabel);
      }
    }
          ...
          <div style={{
            ...
            <div style={{
              ...
              {(() => {
                ...
                const suits = ['♠','♥','♦','♣'];
                const [qpValue, setQpValue] = React.useState('');
                const [qpTarget, setQpTarget] = React.useState('p1'); // p1, p2, p3, b1, b2, b3
