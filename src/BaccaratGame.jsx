...
import {
  ...
  resetSession
} from './useFirebaseSync';import React, { useState, useEffect, useRef, useCallback } from 'react';
import { Users, Timer, Crown, Trophy, Settings, ArrowLeft } from 'lucide-react';
// ========== FIREBASE: Import real-time sync hooks ==========
import { database as db, ref, onValue, set as fbSet } from './firebase.js';
import { useSettings, DEFAULT_ODDS, DEFAULT_VISIBILITY } from './useSettings';
            ...
            >
              ...
              {(currentBets.player + (activeBets.player || 0)) > 0 && (
                <div style={{
                  ...
                  background: '#000', color: '#d4af37', borderRadius: '50%',
                  width: '44px', height: '44px',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  fontSize: '13px', fontWeight: 'bold',
                  border: '1px solid rgba(212, 175, 55, 0.4)', boxShadow: '0 4px 12px rgba(0,0,0,0.5)'
                }}>
