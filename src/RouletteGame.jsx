      ...
      <div style={{ maxWidth: '1400px', margin: '20px auto', padding: '0 20px' }}>
        ...
        <div style={{
          ...
          {(() => {
            ...
            const chipDot = (betKey) => {
              ...
              return (
                <div style={{
                  ...
                  fontSize: '8px', fontWeight: 'bold', border: '2px solid #000',
            ...
            // Cell size
            const W = 52; // number cell width
            const H = 50; // number cell height
            const E = 12; // edge zone size (clickable split area)
                  ...
                  {['0', '00'].map(n => {
                    ...
                    return (
                      <div key={n} onClick={() => placeBet('straight', n)} style={{
                        width: W, height: H * 1.5, background: '#0a6e0a',
                        border: '2px solid #d4af37', borderRadius: '8px',
                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                        cursor: bettingOpen ? 'pointer' : 'not-allowed',
                        position: 'relative', opacity: bettingOpen ? 1 : 0.5
                      }}>
                        <span style={{ fontSize: '18px', fontWeight: 'bold', color: '#fff' }}>{n}</span>
                    ...
                    {rows.flat().map(num => {
                      ...
                      return (
                        <div key={num} onClick={() => placeBet('straight', n)} style={{
                          ...
                          <span style={{ fontSize: '16px', fontWeight: 'bold', color: '#fff' }}>{n}</span>
                          {hasBet > 0 && chipDot(betKey)}
                        </div>
                      );
                    })}
          ...
          <div style={{
            ...
            fontSize: '9px', color: '#aaa', flexWrap: 'wrap'
          }}>
